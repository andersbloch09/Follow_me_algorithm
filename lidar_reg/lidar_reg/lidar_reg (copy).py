...
def main():
    ...
    queue.append([0.1,0])
    queue.append([0.2,0.0])
    queue.append([0.3,0.0])
    queue.append([0.4,0.0])
    queue.append([0.5,0.0])
    queue.append([0.6,0.0])
    queue.append([0.7,0.0])
    queue.append([0.8,0.0])
    queue.append([0.9,0.0])
