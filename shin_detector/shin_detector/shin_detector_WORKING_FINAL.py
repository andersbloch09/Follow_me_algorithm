...
with open('/home/peter/ros2_ws/src/shin_detector/shin_detector/New_Positive_Features.txt', 'r') as f:
...
class WaypointPublisher(Node):
    def __init__(self,coordinates):
        ...
        self.publisher_ = self.create_publisher(Float32MultiArray, 'targetCoordinates', 10)
